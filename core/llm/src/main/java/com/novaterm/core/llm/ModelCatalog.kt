...
object ModelCatalog {
    ...
    val DEFAULT = ModelInfo(
        ...
        description = "Google's latest (Apr 2026). Agentic reasoning, function calling, 32K context. 52 tok/s GPU.",
    ...
    val ALL = listOf(
        ...
        ModelInfo(
            ...
            description = "Strongest on-device model. Best coding + agentic reasoning. Needs 4GB+ free RAM.",
        ...
        ModelInfo(
            ...
            displayName = "Gemma 4 E2B (NPU)",
            description = "Latest Gemma 4 on NPU/GPU. 52 tok/s GPU, 32 tok/s NPU. Agentic + function calling.",
        ...
        ModelInfo(
            ...
            description = "MatFormer architecture, 128+ languages. Lighter than Gemma 4.",
