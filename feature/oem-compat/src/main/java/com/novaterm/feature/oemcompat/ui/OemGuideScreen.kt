...
fun OemGuideScreen(
    ...
    val instructions = OemDetector.getInstructions(oemInfo.brand)
    val needsWhitelist = OemDetector.needsBatteryWhitelist(oemInfo)
    ...
    Scaffold(
        ...
        Column(
            ...
            if (needsWhitelist) {
                ...
                Text(
                    text = "Android ${oemInfo.androidVersion}",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
            }
